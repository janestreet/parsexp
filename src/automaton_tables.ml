...
let transitions : (_ : value mod portable) Basement.Stdlib_iarray_labels.t =
  Basement.Stdlib_iarray_labels.unsafe_of_array
    [| tr_00
     ; tr_00
     ; tr_00
     ; tr_00
...
let transitions_eoi : (_ : value mod portable) Basement.Stdlib_iarray_labels.t =
  Basement.Stdlib_iarray_labels.unsafe_of_array
    [| tr_eoi_00
     ; tr_eoi_01
     ; tr_eoi_02
...
let old_parser_approx_cont_states
  : Old_parser_cont_state.t Basement.Stdlib_iarray_labels.t
  =
  Basement.Stdlib_iarray_labels.unsafe_of_array
